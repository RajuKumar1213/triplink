        ...
        <section className="relative py-16 md:py-24 overflow-hidden">
          <Container className="relative z-10 text-center max-w-4xl">
            ...
            <p className="text-gray-600 font-medium max-w-2xl mx-auto">
              Choose the method that suits you best. All transactions processed securely. For any clarification, reach our support desk.
            </p>
          </Container>
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-8">
                <div className="flex-1 space-y-5">
                  ...
                  <p className="text-sm md:text-base font-medium leading-relaxed text-yellow-50/95">
                    For secure transactions, use only the official payment details on this page. Triplink Adventures is not responsible for payments made to unauthorized accounts. Need help? Call us at <span className="font-semibold">+91 88837 72000</span>.
                  </p>
                </div>
                <div className="w-full md:w-64">
                  <div className="bg-white/15 backdrop-blur rounded-2xl p-5 h-full flex flex-col justify-center text-sm font-semibold tracking-wide space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <AlertCircle className="h-4 w-4" /> Keep Proof of Payment
                    </div>
                    <div className="flex items-center gap-2">
                      <AlertCircle className="h-4 w-4" /> Report Suspicious Calls
                    </div>
                  </div>
                </div>
              </div>
